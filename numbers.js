...
function processClick(tileId){
	...
	if (store1==0){
		...
		document.getElementById(tileId).style.backgroundColor = "rgba(255, 255, 255, 0.2)";
		document.getElementById(store1.toString()).style.backgroundColor = "rgba(255, 255, 255, 0.2)";
